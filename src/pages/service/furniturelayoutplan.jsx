                ...
                <div className="row txt-container">
                  <div className="col-lg-10">
                    <div className="txt-cont align-middle">
                      ...
                      <br />
                      <p className="mb-20 ">
                        • การจัดวางตำแหน่งเฟอร์นิเจอร์ และฟังก์ชันการใช้งานเป็นเรื่องสำคัญอินฟินิท 168 ดีไซน์ จัดวางฟังก์ชันที่คุฯต้องการให้เหมาะสมกับการใช้งานมากที่สุด และสอดคล้องกับความต้องการของลูกค้า
                      </p>
                      ...
                      <p><center>** โทร: 061-899-6168 หรือ 095-575-4653 คุณสไปรท์**</center></p>
